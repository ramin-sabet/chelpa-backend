...
class Server {
  ...
  public config(): void {
    ...
    let urlOpenShift = '127.0.0.1:27017/' + process.env.OPENSHIFT_ChelpaNode;// const MONGO_URI: string = 'mongodb+srv://ramin_sabet:NmMnNmMn@gettingstarted-hgi96.mongodb.net/chalpa'
